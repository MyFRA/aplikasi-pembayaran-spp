                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if( $month['status'] != 'Lunas' ): ?>
                                                    ...
                                                    <?php endif; ?>
                                                    <?php if( $month['status'] != 'Belum Bayar' ): ?>
                                                        <a class="btn btn-sm btn-primary" href="<?php echo e(url('/app-admin/histori-pembayaran/siswa/' . $siswa->nisn)); ?>">Lihat Histori</a>
                                                    <?php endif; ?>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ujikom-tomy-wibowo-xii-rpl-1\aplikasi-spp\resources\views/admin/pages/siswa/lihat-spp.blade.php ENDPATH**/ ?>