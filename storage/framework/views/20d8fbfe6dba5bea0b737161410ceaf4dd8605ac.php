...
<body>
    <div style="border: 1px solid #000; padding: 1rem">
        <table>
            ...
            <tr>
                <td>Rp . <?php echo e($pembayaran->jumlah_bayar); ?></td>
                <td></td>
                <td></td>
            </tr>
        </table>
...
</html><?php /**PATH /media/tomy/E4B868F2B868C520/aplikasi-spp/resources/views/admin/pages/histori-pembayaran/kuitansi.blade.php ENDPATH**/ ?>