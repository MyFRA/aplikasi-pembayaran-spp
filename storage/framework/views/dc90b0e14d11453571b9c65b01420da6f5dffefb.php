...
<div class="row">
    <div class="col">
        <div class="card">
            ...
            <div class="card-body">
                <a href="<?php echo e(url('/app-admin/kelas/create')); ?>" class="btn btn-primary mb-4">Tambah <?php echo e($title); ?></a>
                        ...
                        <table class="table table-bordered table-md">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e($class->nama_kelas); ?></td>
                                    <td><?php echo e($class->kompetensiKeahlian->nama_kompetensi_keahlian); ?></td>
                                    <td>
                                        <a href="<?php echo e(url('/app-admin/kelas/' . encrypt($class->id_kelas) . '/edit')); ?>" class="btn btn-sm btn-primary"><i class="fas fa-edit"></i> Edit</a>
                                        <a href="#" class="btn btn-sm btn-danger" onclick="deleteRow('Kelas <?php echo e($class->nama_kelas); ?>', '<?php echo e(url('/app-admin/kelas/' . encrypt($class->id_kelas))); ?>')"><i class="fas fa-trash"></i> Hapus</a>
                                    </td>
                                </tr>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ujikom-tomy-wibowo-xii-rpl-1\aplikasi-spp\resources\views/admin/pages/kelas/index.blade.php ENDPATH**/ ?>