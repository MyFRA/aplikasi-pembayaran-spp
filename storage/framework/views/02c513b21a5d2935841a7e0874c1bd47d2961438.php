...
<?php endif; ?>
                <?php endif; ?>
                <form action="<?php echo e(url('app-admin/siswa/' . $siswa->nisn . '/bayar/' . encrypt($spp->id_spp) . '/' . $month . '/' . $pembayaran->id_pembayaran)); ?>" method="post" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ujikom-tomy-wibowo-xii-rpl-1\aplikasi-spp\resources\views/admin/pages/siswa/edit-spp.blade.php ENDPATH**/ ?>