...
<?php endif; ?>
                <?php endif; ?>
                <form action="<?php echo e(url('/app-admin/kompetensi-keahlian')); ?>" method="post">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('nama_kompetensi_keahlian')); ?>" placeholder="nama kompetensi keahlian" autocomplete="off">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ujikom-tomy-wibowo-xii-rpl-1\aplikasi-spp\resources\views/admin/pages/kompetensi-keahlian/create.blade.php ENDPATH**/ ?>