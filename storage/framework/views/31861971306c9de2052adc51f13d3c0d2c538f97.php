...
<?php endif; ?>
                <?php endif; ?>
                <form action="<?php echo e(url('/app-admin/siswa')); ?>" method="post" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('nama')); ?>" placeholder="nama siswa" autocomplete="off" id="nama">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('nisn')); ?>" placeholder="nisn" autocomplete="off" id="nisn">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="nis" class="form-control <?php $__errorArgs = ['nis'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('nis')); ?>" placeholder="nis" autocomplete="off" id="nis">
                          ...
                          <?php $__currentLoopData = $jenis_kelamins; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jenis_kelamin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($jenis_kelamin); ?>"
                                <?php if( old('jenis_kelamin') ): ?>
                                    <?php echo e(old('jenis_kelamin') == $jenis_kelamin ? 'selected' : ''); ?>

                                <?php endif; ?>
                             ><?php echo e($jenis_kelamin); ?></option>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('no_telp')); ?>" placeholder="no telp" autocomplete="off" id="no_telp">
...
unset($__errorArgs, $__bag); ?>" style="height: 100px" placeholder="alamat"><?php echo e(old('alamat')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($kelas->nama_kelas); ?>" placeholder="kelas" autocomplete="off" id="nama_kelas" readonly>
                        <input type="hidden" name="id_kelas" class="form-control <?php $__errorArgs = ['id_kelas'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(encrypt($kelas->id_kelas)); ?>" placeholder="kelas" autocomplete="off" id="id_kelas">
                    </div>
                    <hr>
                    <div class="form-group d-flex justify-content-between">    
                        <button class="btn btn-primary"><i class="fas fa-save mr-1"></i> Simpan</button>
                        <a href="<?php echo e(url('/app-admin/siswa/kelas/' . encrypt($kelas->id_kelas))); ?>" class="btn btn-dark">Kembali</a>
                    </div>
                </form>
            </div>
        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ujikom-tomy-wibowo-xii-rpl-1\aplikasi-spp\resources\views/admin/pages/siswa/create.blade.php ENDPATH**/ ?>