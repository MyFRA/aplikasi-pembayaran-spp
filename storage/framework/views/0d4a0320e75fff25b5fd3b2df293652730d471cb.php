...
<?php endif; ?>
                <?php endif; ?>
                <form action="<?php echo e(url('/app-admin/spp')); ?>" method="post">
                    <?php echo csrf_field(); ?>
                    <div class="form-group">
                        <label for="tahun_ajaran" class="font-weight-bold">Tahun Ajaran <span class="text-danger">*</span></label>
                        <div class="d-flex align-items-center">
                            <div>
                                <input type="number" class="form-control <?php $__errorArgs = ['tahun_pertama'];
...
unset($__errorArgs, $__bag); ?>" name="tahun_pertama" id="tahun_pertama" placeholder="tahun pertama" value="<?php echo e(old('tahun_pertama')); ?>" autocomplete="off" min="1000" max="9999">
                                <?php $__errorArgs = ['tahun_pertama'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                <input type="number" class="form-control <?php $__errorArgs = ['tahun_kedua'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="tahun_kedua" id="tahun_kedua" placeholder="tahun kedua" value="<?php echo e(old('tahun_kedua')); ?>" autocomplete="off" min="1000" max="9999">
                                <?php $__errorArgs = ['tahun_kedua'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        <label for="nominal" class="font-weight-bold">Nominal SPP <span class="text-danger">*</span></label>
                        <input type="text" name="nominal" class="form-control <?php $__errorArgs = ['nominal'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('nominal')); ?>" placeholder="nominal spp" autocomplete="off" id="nominal">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group d-flex justify-content-between">    
                        ...
                        <a href="<?php echo e(url('/app-admin/spp')); ?>" class="btn btn-dark">Kembali</a>
                    </div>
                </form>
            </div>
        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ujikom-tomy-wibowo-xii-rpl-1\aplikasi-spp\resources\views/admin/pages/spp/create.blade.php ENDPATH**/ ?>