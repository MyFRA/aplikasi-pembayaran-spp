    ...
    <div class="col-lg-7">
        <div class="card">
            ...
            <div class="card-body">
                ...
                @endif
                <form action="{{ url('/app-admin/kelas') }}" method="post">
                    @csrf
                    <div class="form-group">
                        <label for="nama_kelas" class="font-weight-bold">Nama Kelas <span class="text-danger">*</span></label>
                        <input type="text" name="nama_kelas" class="form-control @error('nama_kelas') is-invalid @enderror" value="{{ old('nama_kelas') }}" placeholder="nama kelas" autocomplete="off">
